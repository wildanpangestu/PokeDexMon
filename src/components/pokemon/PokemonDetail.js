...
export default class PokemonDetail extends Component {
  ...
  async componentDidMount() {
    ...
    const imageUrl = `https://raw.githubusercontent.com/HybridShivam/Pokemon/master/assets/images/${pad(
      pokemonIndex,
      3
    )}.png`;
    ...
    // Convert decimeters to feet, + 0.0001 * 100) / 100 is for rounding to 2 decimal places
    const height =
